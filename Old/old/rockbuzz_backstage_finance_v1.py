    ...
    if df.empty or df["data"].isna().all():
        ...
        if dfp.empty:
            ...
            axis_style = dict(
                ...
                gridcolor="#1a1a2e",
                linecolor="#1a1a2e",
                tickfont=dict(size=10, color="#1a1a2e", family="Inter, sans-serif"),
            )
                ...
                if not monthly.empty:
                    ...
                    fig.update_layout(
                        **chart_layout,
                        ...
                        yaxis=dict(title='Valor (R$)', showgrid=True, gridcolor='#1a1a2e'),
                        height=500,
                        hovermode='x unified',
                ...
                if dd.empty:
                    ...
                    fig_evol.update_layout(
                        **chart_layout,
                        ...
                        yaxis=dict(title='Saldo (R$)', showgrid=True, gridcolor='#1a1a2e'),
                        height=500,
                        hovermode='x unified',
                        showlegend=False
                    )
                ...
                if cat_agg.empty:
                    ...
                    fig_cat.update_layout(
                        **chart_layout,
                        ...
                        xaxis=dict(title='Saldo (R$)', showgrid=True, gridcolor='#1a1a2e', zeroline=True, zerolinecolor='#1a1a2e', zerolinewidth=2),
                        ...
                        if not eventos_agg.empty:
                            ...
                            fig_shows.update_layout(
                                **chart_layout,
                                ...
                                xaxis=dict(title='Receita (R$)', showgrid=True, gridcolor='#1a1a2e'),
                                yaxis=dict(title='', showgrid=False)
                            )
                    ...
                    if ticket_por_mes:
                        ...
                        fig_ticket.update_layout(
                            **chart_layout,
                            ...
                            xaxis=dict(title='Mês', showgrid=False),
                            yaxis=dict(title='Ticket Médio (R$)', showgrid=True, gridcolor='#1a1a2e'),
